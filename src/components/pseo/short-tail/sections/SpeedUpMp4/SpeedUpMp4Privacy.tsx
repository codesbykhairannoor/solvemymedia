...
export const SpeedUpMp4Privacy: React.FC<{ data: any }> = ({ data }) => {
  return (
    <Box sx={{ py: 12, background: '#0f172a', color: 'white', mb: '80px', borderRadius: '40px', mx: { xs: 2, lg: 4 } }}>
      <Container maxWidth="md" sx={{ textAlign: 'center' }}>
        <Box sx={{ 
          ...
          <Briefcase size={40} color="#2dd4bf" />
        </Box>
