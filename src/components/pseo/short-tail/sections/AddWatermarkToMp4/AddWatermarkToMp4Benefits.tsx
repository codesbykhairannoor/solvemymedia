...
export const AddWatermarkToMp4Benefits: React.FC<{ data: any }> = ({ data }) => {
  return (
    <Box sx={{ background: '#f8fafc', py: 10, mb: '80px' }}>
        ...
        <Box sx={{ 
          ...
          <Box sx={{ flex: 1, width: '100%' }}>
            <Box sx={{ 
              ...
              <Shield size={100} strokeWidth={1} color="var(--primary-main)" />
            </Box>
          </Box>
          <Box sx={{ flex: 1, width: '100%' }}>
